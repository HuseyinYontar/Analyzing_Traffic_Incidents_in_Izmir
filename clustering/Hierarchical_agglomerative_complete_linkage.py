...
def save_linkage_dendrogram_pdf(X, labels_text, out_pdf_path, method: str):
...
def run_one_dataset(xlsx_path, dataset_name, k_target, dendro_pdf_path, translate_names=False, method="complete"):
    ...
    Z = save_linkage_dendrogram_pdf(X, names, dendro_pdf_path, method=method)
...
if __name__ == "__main__":
    ...
    # output filenames for COMPLETE linkage
    districts_dendro_pdf = os.path.join(base_dir, "Agglomerative_CompleteLinkage_Districts_Dendrogram.pdf")
    streets_dendro_pdf = os.path.join(base_dir, "Agglomerative_CompleteLinkage_Streets_Dendrogram.pdf")

    run_one_dataset(
        xlsx_path=districts_xlsx,
        dataset_name="Districts (Agglomerative Complete Linkage)",
        k_target=4,
    ...
    run_one_dataset(
        ...
        dataset_name="Streets (Agglomerative Complete Linkage)",
        k_target=6,
