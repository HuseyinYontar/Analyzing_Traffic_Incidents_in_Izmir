...
# MLP için olan uyarıları susturuyorduk, KNN'de gerek yok ama kalsın sorun değil
...
#    (Bütün feature'lar kategorik olduğu için hepsine OHE)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# 9) GridSearch için KNN pipeline
# ---------------------------------------------------------
knn_base = KNeighborsClassifier()  # default, hiperparametreleri grid'de ayarlayacağız
...
# ---------------------------------------------------------
# 10) Test set performansı (best KNN modeli ile)
# ---------------------------------------------------------
